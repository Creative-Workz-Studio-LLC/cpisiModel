...
docker start cpisi-sentinel || docker run -d --name cpisi-sentinel -v "${PROJECT_ROOT}/02_body/b-spiral/sandbox:/root/mobile_sandbox" cpisi-agent-node:a-01.01 ./sandbox-engine
